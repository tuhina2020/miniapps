...
async function main(bucketName, directoryPath, bucketPath) {
	console.log(bucketName, directoryPath);
  ...
  async function uploadDirectory() {
    ...
    async function onComplete() {
			const destinationPathDirName = path.dirname(bucketName + bucketPath);
			console.log(destinationPathDirName);
      const resp = await Promise.all(
        fileList.map(filePath => {
					let destination = bucketName + bucketPath + filePath;
