...
import rabindraBeforeBg from '@/indiannewyear/assets/background/before/rabindra.png'
import rabindraAfterBg from '@/indiannewyear/assets/background/after/rabindra.png'
...
export const INPUT_WRAPPER_CLASS = {
	...
	Rabindranath: {
		// wrapperClass: "Pos(a) T(55vw) Mx(25%)",
		wrapperClass: "M(2.7vw)",
		inputBoxClass: "Bdrs(4px) Bgc(#343517) H(8vw) W(50vw) Fz(3vw) P(3vw) Ff($ffroboto) Bd C(#e2b911) Bxz(bb) Bd(n):h Bdc(t):h"
	},
}
...
export const ENTER_BUTTON_CLASS = {
	...
	Rabindranath: {
		// wrapperClass: "Pos(a) T(68vw) Mx(35%) Ta(c) W(30%)",
		wrapperClass: "M(2.7vw)",
		textBoxClass: "C(white) Bgc(#e2b911) Fw(700) Ff($ffroboto) Py(10px) Px(20px) Bdrs(5px) Fz(3vw) C(#141414)"
	},
}
...
export const TEXT_BOX_CLASS = {
	...
	Rabindranath: {
		wrapperClass: "My(3vw) Mx(16.6vw)",
		textBoxClass: "Ff($ffroboto) Fw(500) Fz(4.4vw) Lh(5.2vw) C(#e2b911) Ta(c)"
	}
}
...
export const TEXT_BOX2_CLASS = {
	...
	Rabindranath: {
		wrapperClass: "Pos(r) T(17vw) Mx(10vw)",
		textBoxClass: "Ff($ffroboto) Fw(500) Fz(4vw) Lh(3.8vw) C(#e2b911) Ta(c)"
	}
}
...
export const PLACEHOLDER = {
	...
	Rabindranath: 'যোগদান করতে নাম এন্টার করুন',
	Bengali: "Please Enter Your Friend's name"
}
